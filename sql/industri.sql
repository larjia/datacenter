...
insert into sys_menu values('6', '采购',    '0', '6', 'purchasing',          null,   1, 'M', '0', '', 'tool',     'admin', '2020-03-10 11-33-00', 'admin', '2018-03-16 11-33-00', '采购目录');
-- 二级菜单
...
insert into sys_menu values('109',  '在线用户', '2',   '1', 'online',     'monitor/online/index',     1, 'C', '1', 'monitor:online:list',     'online',        'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '在线用户菜单');
insert into sys_menu values('110',  '定时任务', '2',   '2', 'job',        'monitor/job/index',        1, 'C', '1', 'monitor:job:list',        'job',           'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '定时任务菜单');
insert into sys_menu values('111',  '数据监控', '2',   '3', 'druid',      'monitor/druid/index',      1, 'C', '1', 'monitor:druid:list',      'druid',         'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '数据监控菜单');
insert into sys_menu values('112',  '服务监控', '2',   '4', 'server',     'monitor/server/index',     1, 'C', '1', 'monitor:server:list',     'server',        'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '服务监控菜单');
insert into sys_menu values('113',  '表单构建', '3',   '1', 'build',      'tool/build/index',         1 ,'C', '1', 'tool:build:list',         'build',         'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '表单构建菜单');
insert into sys_menu values('114',  '代码生成', '3',   '2', 'gen',        'tool/gen/index',           1, 'C', '1', 'tool:gen:list',           'code',          'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '代码生成菜单');
insert into sys_menu values('115',  '系统接口', '3',   '3', 'swagger',    'tool/swagger/index',       1, 'C', '1', 'tool:swagger:list',       'swagger',       'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '系统接口菜单');
...
insert into sys_menu values('120',  '采购订单查询', '6','1', 'purchaseorder',  'purchasing/purchaseorder/index', 1, 'M', '0', '',               'table',          'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '采购订单查询菜单');
...
-- demo data
insert into prod_report_hist values (100, '2020-02-26', '2020-02-26', '06:00', '15:00', 'F662 (FORD  FEU)', '2300010127', '高压车间', '压装焊接班', '压装', '金学枝', '0', '', 900, 0, 0, 900, 1, 0, 'admin', '2020-03-15 23-19-00', 'admin', '2020-03-15 23-19-00');
insert into prod_report_hist values (101, '2020-02-26', '2020-02-26', '06:00', '15:00', 'F662 (FORD  FEU)', '2300010127', '高压车间', '压装焊接班', '压装', '邓小红', '1', '', 300, 0, 0, 300, 1, 0, 'admin', '2020-03-15 23-19-00', 'admin', '2020-03-15 23-19-00');
insert into prod_report_hist values (102, '2020-02-26', '2020-02-26', '06:00', '15:00', 'F662 (FORD  FEU)', '2300010127', '高压车间', '压装焊接班', '激光焊', '金学枝', '0', '', 650, 0, 0, 650, 1, 0, 'admin', '2020-03-15 23-19-00', 'admin', '2020-03-15 23-19-00');
insert into prod_report_hist values (103, '2020-02-26', '2020-02-26', '06:00', '15:00', 'F662 (FORD  FEU)', '2300010127', '高压车间', '压装焊接班', '激光焊', '邓小红', '1', '', 550, 0, 0, 550, 1, 0, 'admin', '2020-03-15 23-19-00', 'admin', '2020-03-15 23-19-00');
insert into prod_report_hist values (104, '2020-02-26', '2020-02-26', '06:00', '15:00', 'F662 (FORD  FEU)', '2300010127', '高压车间', '检验班', '综检', '袁芳', '0', '支架板、支架块孔距不良', 180, 5, 0, 175, 0.9722, 27778, 'admin', '2020-03-15 23-19-00', 'admin', '2020-03-15 23-19-00');
insert into prod_report_hist values (105, '2020-02-26', '2020-02-26', '06:00', '15:00', 'PSA-EB2GDI KVS', '2300240004', '高压车间', '检验班', '综检', '杨芹', '1', '管接头轮廓度不良', 590, 0, 0, 590, 1, 0, 'admin', '2020-03-15 23-19-00', 'admin', '2020-03-15 23-19-00');
insert into prod_report_hist values (106, '2020-02-26', '2020-02-26', '06:00', '15:00', 'PSA-EB2GDI KVS', '2300240004', '高压车间', '包装入库班', '包装', '金学枝', '0', '', 540, 0, 0, 540, 1, 0, 'admin', '2020-03-15 23-19-00', 'admin', '2020-03-15 23-19-00');
insert into prod_report_hist values (107, '2020-02-26', '2020-02-26', '06:00', '15:00', 'PSA-EB2GDI KVS', '2300240004', '高压车间', '压装焊接班', '压装', '杨芹', '0', '', 480, 0, 0, 480, 1, 0, 'admin', '2020-03-15 23-19-00', 'admin', '2020-03-15 23-19-00');
insert into prod_report_hist values (108, '2020-02-26', '2020-02-26', '06:00', '15:00', 'PSA-EB2GDI KVS', '2300240004', '高压车间', '压装焊接班', '压装', '杨芹', '1', '', 300, 0, 0, 300, 1, 0, 'admin', '2020-03-15 23-19-00', 'admin', '2020-03-15 23-19-00');
insert into prod_report_hist values (109, '2020-02-26', '2020-02-26', '06:00', '15:00', 'PSA-EB2GDI KVS', '2300240004', '高压车间', '压装焊接班', '激光焊', '袁芳', '0', '', 180, 0, 0, 180, 1, 0, 'admin', '2020-03-15 23-19-00', 'admin', '2020-03-15 23-19-00');
insert into prod_report_hist values (110, '2020-02-26', '2020-02-26', '06:00', '15:00', 'PSA-EB2GDI KVS', '2300240004', '高压车间', '压装焊接班', '激光焊', '袁芳', '1', '', 450, 0, 0, 450, 1, 0, 'admin', '2020-03-15 23-19-00', 'admin', '2020-03-15 23-19-00');
